...
var white_balance_warm_color = preload("res://addons/post_processing_tool/assets/warm_color.res")
var white_balance_cool_color = preload("res://addons/post_processing_tool/assets/cool_color.res")
